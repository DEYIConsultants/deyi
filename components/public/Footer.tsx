        ...
        <Card className="bg-white shadow-none text-midnight-blue text-sm">
          ...
          <CardContent className="flex flex-row items-center justify-center space-x-6 py-2">
            <Link href="/" legacyBehavior passHref>
              <span className="text-midnight-blue cursor-pointer text-xs">About</span>
            </Link>
            <Link href="/" legacyBehavior passHref>
              <span className="text-midnight-blue cursor-pointer text-xs">Expertise</span>
            </Link>
            <Link href="/" legacyBehavior passHref>
              <span className="text-midnight-blue cursor-pointer text-xs">Procedure</span>
            </Link>
            <Link href="/" legacyBehavior passHref>
              <span className="text-midnight-blue cursor-pointer text-xs">Contact</span>
            </Link>
            <Link href="/" legacyBehavior passHref>
              <span className="text-midnight-blue cursor-pointer text-xs">Login</span>
            </Link>
          </CardContent>
